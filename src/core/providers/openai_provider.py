...
class OpenAIProvider(ModelProvider):
    ...
    def _build_default_system_prompt(self) -> str:
        ...
        return (
            ...
            "ACCESSING CONTEXT (VERY IMPORTANT):\n"
            "The context dict is injected automatically at the start of your code.\n"
            "✅ CORRECT way to access context:\n"
            "   email_user = context['email_user']\n"
            "   password = context['email_password']\n"
            "   host = context.get('imap_host', 'imap.gmail.com')\n\n"
            "❌ WRONG - These will cause NameError:\n"
            "   extract_data(email_user, password)  # Variables don't exist!\n"
